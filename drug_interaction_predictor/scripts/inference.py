...
from  drug_interaction_predictor.scripts.feature_generation import smiles_to_ECFP, tokenize_SMILES
...
from drug_interaction_predictor.scripts.model import AttentionWithContext
import argparse
