...
from keras.layers import LSTM, MaxPooling1D, Conv1D, GlobalMaxPooling1D, GlobalAveragePooling1D, Conv2D, MaxPool2D
...
class Model():
    ...
    def lstm_train(self,X_train, y_train):
    ...
    def lstm_2layer_train(self,X_train, y_train):
    ...
    def cnn_lstm_train(self,X_train, y_train):
    ...
    def cnn_2layer_lstm(self,X_train, y_train):
    ...
    def model_cnn(self,X_train, y_train):
    ...
    def model_lstm_du(self,X_train, y_train):
    ...
    def lstm_2layer_du(self,X_train, y_train):
    ...
    def model_lstm_atten(self,X_train, y_train):
    ...
    def cnn_1lstm_atten(self,X_train, y_train):
    ...
    def cnn_2lstm_atten(self,X_train, y_train):
        '''Build and return a 2 layer lstm model preceded by a CNN with Maxpooling and followed by attention, optimised for GPU
                    Args :
                        x_train (numpy.ndarray): Features for training
                        y_train (numpy.ndarray): Classification labels for training
    ...
    def cnn_3lstm_atten(self,X_train, y_train):
    ...
    def mlp_mol2vec_train(self,x_train, y_train):
    ...
    def get_model_from_name(self, model_name):
        model = None
        list_of_methods = inspect.getmembers(self, predicate=inspect.ismethod)
        for method in list_of_methods:
            if method[0] == model_name:
                model = method[1]
                break
